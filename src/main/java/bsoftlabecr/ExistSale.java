...
public class ExistSale {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            existSaleResponse = cashRegisterClient.getExistSaleResponse(existSaleRequest);
        ...
        try {
            ...
            existSaleResponseWriterXml.setFileName(ExistSaleResponseXmlFileName);
