...
import bsoftlabecr.xml.reader.receipt.returns.prepayment.NewPartialReturnPrepaymentRequestReaderXml;
import bsoftlabecr.xml.reader.constants.ConstantsReaderXml;
import bsoftlabecr.xml.writer.receipt.returns.prepayment.NewPartialReturnPrepaymentResponseWriterXml;

import java.util.List;

public class NewPartialReturnPrepayment {
    private static final String ConstantsXmlFileName =
            "bsoftlabecrdata/Constants.xml";
    private static final String NewPartialReturnPrepaymentRequestXmlFileName =
            "bsoftlabecrdata/NewPartialReturnPrepaymentRequest.xml";
    private static final String NewPartialReturnPrepaymentResponseXmlFileName =
            "bsoftlabecrdata/NewPartialReturnPrepaymentResponse.xml";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cashiersAndDepsResponse = cashRegisterClient
        ...
        try {
            ...
            NewPartialReturnPrepaymentRequestReaderXml
                    newPartialReturnPrepaymentRequestReaderXml =
                    new NewPartialReturnPrepaymentRequestReaderXml();
            newPartialReturnPrepaymentRequestReaderXml
                    .setFileName(NewPartialReturnPrepaymentRequestXmlFileName);
            System.out.println("BSOFTLAB. Reading request from file: " +
                    newPartialReturnPrepaymentRequestReaderXml.getFileName());
            newPartialReturnPrepaymentRequest =
                    newPartialReturnPrepaymentRequestReaderXml.readFile();
            newPartialReturnPrepaymentRequest.setSeq(cashRegisterClient.getSeq());
        ...
        try {
            ...
            newPartialReturnPrepaymentResponse =
                    cashRegisterClient.getNewPartialReturnPrepaymentResponse(
                            newPartialReturnPrepaymentRequest);
            ...
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " +
                    newPartialReturnPrepaymentResponse.getResponseCode());
            System.out.println();
        } catch (OperationException operationException) {
            System.out.println(operationException.getMessage());
            return;
        ...
        try {
            ...
            NewPartialReturnPrepaymentResponseWriterXml
                    newPartialReturnPrepaymentResponseWriterXml =
                    new NewPartialReturnPrepaymentResponseWriterXml();
            newPartialReturnPrepaymentResponseWriterXml
                    .setFileName(NewPartialReturnPrepaymentResponseXmlFileName);
            System.out.println("BSOFTLAB. Writing response into file: " +
                    newPartialReturnPrepaymentResponseWriterXml.getFileName());
            newPartialReturnPrepaymentResponseWriterXml
                    .writeFile(newPartialReturnPrepaymentResponse);
