...
public class NewOriginalReturnPrepaymentResponseWriterXml {
    ...
    private static final String RESPONSE_OPEN = "<NewOriginalReturnPrepaymentResponse>";
    private static final String RESPONSE_CLOSE = "</NewOriginalReturnPrepaymentResponse>";
    ...
    public void writeFile(NewOriginalReturnPrepaymentResponse
