...
public class ExistReturnSaleResponseWriterXml {
    ...
    private static final String RESPONSE_OPEN = "<ExistReturnSaleResponse>";
    private static final String RESPONSE_CLOSE = "</ExistReturnSaleResponse>";
    ...
    public ExistReturnSaleResponseWriterXml() {}
    ...
    public void writeFile(ExistReturnSaleResponse existReturnSaleResponse)
        ...
        try {
            ...
            writer.write(TAB_KEY + RESPONSE_CID_OPEN + existReturnSaleResponse.getCid() + RESPONSE_CID_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_TIME_OPEN + existReturnSaleResponse.getTime() + RESPONSE_TIME_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_TA_OPEN + existReturnSaleResponse.getTa() + RESPONSE_TA_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_CASH_OPEN + existReturnSaleResponse.getCash() + RESPONSE_CASH_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_CARD_OPEN + existReturnSaleResponse.getCard() + RESPONSE_CARD_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_PPA_OPEN + existReturnSaleResponse.getPpa() + RESPONSE_PPA_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_PPU_OPEN + existReturnSaleResponse.getPpu() + RESPONSE_PPU_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_TYPE_OPEN + existReturnSaleResponse.getType() + RESPONSE_TYPE_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_REF_OPEN + existReturnSaleResponse.getRef() + RESPONSE_REF_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_REFCRN_OPEN + existReturnSaleResponse.getRefcrn() + RESPONSE_REFCRN_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_SALETYPE_OPEN + existReturnSaleResponse.getSaleType() + RESPONSE_SALETYPE_CLOSE + ENTER_KEY);
            writer.write(TAB_KEY + RESPONSE_CODE_OPEN + existReturnSaleResponse.getResponseCode() + RESPONSE_CODE_CLOSE + ENTER_KEY);
