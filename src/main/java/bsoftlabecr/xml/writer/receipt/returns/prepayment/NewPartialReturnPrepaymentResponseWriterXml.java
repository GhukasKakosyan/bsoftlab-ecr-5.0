...
public class NewPartialReturnPrepaymentResponseWriterXml {
    ...
    private static final String RESPONSE_OPEN = "<NewPartialReturnPrepaymentResponse>";
    private static final String RESPONSE_CLOSE = "</NewPartialReturnPrepaymentResponse>";
    ...
    public void writeFile(NewPartialReturnPrepaymentResponse
