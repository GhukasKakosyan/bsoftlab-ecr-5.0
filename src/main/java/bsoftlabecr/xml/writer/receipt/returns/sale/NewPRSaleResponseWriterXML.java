...
public class NewPRSaleResponseWriterXML {
    ...
    private static final String RESPONSE_OPEN = "<NewPRSaleResponse>";
    private static final String RESPONSE_CLOSE = "</NewPRSaleResponse>";
    ...
    public void writeFile(NewPRSaleResponse newPartialReturnSaleResponse) throws IOException {
        ...
        writer.write(TAB_KEY + RESPONSE_RSEQ_OPEN + newPartialReturnSaleResponse.getRseq() + RESPONSE_RSEQ_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CRN_OPEN + newPartialReturnSaleResponse.getCrn() + RESPONSE_CRN_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_SN_OPEN + newPartialReturnSaleResponse.getSn() + RESPONSE_SN_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TIN_OPEN + newPartialReturnSaleResponse.getTin() + RESPONSE_TIN_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TAXPAYER_OPEN + newPartialReturnSaleResponse.getTaxpayer() + RESPONSE_TAXPAYER_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_ADDRESS_OPEN + newPartialReturnSaleResponse.getAddress() + RESPONSE_ADDRESS_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TIME_OPEN + newPartialReturnSaleResponse.getTime() + RESPONSE_TIME_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_FISCAL_OPEN + newPartialReturnSaleResponse.getFiscal() + RESPONSE_FISCAL_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_LOTTERY_OPEN + newPartialReturnSaleResponse.getLottery() + RESPONSE_LOTTERY_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_PRIZE_OPEN + newPartialReturnSaleResponse.getPrize() + RESPONSE_PRIZE_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TOTAL_OPEN + newPartialReturnSaleResponse.getTotal() + RESPONSE_TOTAL_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CHANGE_OPEN + newPartialReturnSaleResponse.getChange() + RESPONSE_CHANGE_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_QR_OPEN + newPartialReturnSaleResponse.getQr() + RESPONSE_QR_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CODE_OPEN + newPartialReturnSaleResponse.getResponseCode() + RESPONSE_CODE_CLOSE + ENTER_KEY);
