...
public class NewORSaleResponseWriterXML {
    ...
    private static final String RESPONSE_OPEN = "<NewORSaleResponse>";
    private static final String RESPONSE_CLOSE = "</NewORSaleResponse>";
    ...
    public void writeFile(NewORSaleResponse newOriginalReturnSaleResponse) throws IOException {
