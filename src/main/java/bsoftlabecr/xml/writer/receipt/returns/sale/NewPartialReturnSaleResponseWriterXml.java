...
public class NewPartialReturnSaleResponseWriterXml {
    ...
    private static final String RESPONSE_OPEN = "<NewPartialReturnSaleResponse>";
    private static final String RESPONSE_CLOSE = "</NewPartialReturnSaleResponse>";
    ...
    public void writeFile(NewPartialReturnSaleResponse newPartialReturnSaleResponse)
