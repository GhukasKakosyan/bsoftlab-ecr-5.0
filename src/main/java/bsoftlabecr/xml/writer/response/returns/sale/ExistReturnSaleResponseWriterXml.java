...
public class ExistReturnSaleResponseWriterXml {
    ...
    private static final String XML_TAG_OPEN = "<ExistReturnSaleResponse>";
    private static final String XML_TAG_CLOSE = "</ExistReturnSaleResponse>";
    ...
    private static final String XML_TAG_CODE_OPEN = "<rcode>";
    private static final String XML_TAG_CODE_CLOSE = "</rcode>";
    ...
    private ExistReturnSaleResponse existReturnSaleResponse;
    private String fileName;

    public ExistReturnSaleResponseWriterXml(
            ExistReturnSaleResponse existReturnSaleResponse, String fileName) {
        this.existReturnSaleResponse = existReturnSaleResponse;
        this.fileName = fileName;
    }

    public ExistReturnSaleResponse getExistReturnSaleResponse() {
        return this.existReturnSaleResponse;
    }
    ...
    public void write() throws XmlFileWriteException {
        try {
            ...
            throw new XmlFileWriteException(ResponseType
                    .EXIST_RETURN_SALE_RESPONSE_XML_FILE_WRITE_ERROR.getCode());
        }
    }
}