...
public class ExistRSale {
    public static void main(String[] args) {
        try {
            ...
            ExistRSaleRequestReaderXML existRSaleRequestReaderXML;
            existRSaleRequestReaderXML = new ExistRSaleRequestReaderXML();
            ...
            existRSaleRequest.setSeq(cashRegisterClient.getSeq());
            ...
            ExistRSaleResponse existRSaleResponse = cashRegisterClient.getExistRSaleResponse(existRSaleRequest);
            System.out.println("BSOFTLAB. Request is sent to ECR successfully !");
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " + existRSaleResponse.getResponseCode());
            System.out.println();
