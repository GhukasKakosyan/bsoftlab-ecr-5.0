...
import bsoftlabecr.xml.reader.request.prepayment.NewPrepaymentRequestReaderXml;
...
import bsoftlabecr.xml.writer.response.prepayment.NewPrepaymentResponseWriterXml;
            ...
            try {
                ...
                NewPrepaymentRequestReaderXml newPrepaymentRequestReaderXml =
                        new NewPrepaymentRequestReaderXml(
                                NewPrepaymentRequestXmlFileName);
                System.out.println("BSOFTLAB. Reading request for new prepayment request from file: " +
                        newPrepaymentRequestReaderXml.getFileName());
                NewPrepaymentRequest newPrepaymentRequest =
                        newPrepaymentRequestReaderXml.read();
