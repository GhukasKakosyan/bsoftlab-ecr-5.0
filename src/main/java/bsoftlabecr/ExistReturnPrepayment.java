...
import bsoftlabecr.xml.reader.receipt.returns.prepayment.ExistReturnPrepaymentRequestReaderXml;
import bsoftlabecr.xml.reader.constants.ConstantsReaderXml;
import bsoftlabecr.xml.writer.receipt.returns.prepayment.ExistReturnPrepaymentResponseWriterXml;

import java.util.List;

public class ExistReturnPrepayment {
    private static final String ConstantsXmlFileName =
            "bsoftlabecrdata/Constants.xml";
    private static final String ExistReturnPrepaymentRequestXmlFileName =
            "bsoftlabecrdata/ExistReturnPrepaymentRequest.xml";
    private static final String ExistReturnPrepaymentResponseXmlFileName =
            "bsoftlabecrdata/ExistReturnPrepaymentResponse.xml";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ExistReturnPrepaymentRequestReaderXml existReturnPrepaymentRequestReaderXml
                    = new ExistReturnPrepaymentRequestReaderXml();
            existReturnPrepaymentRequestReaderXml
                    .setFileName(ExistReturnPrepaymentRequestXmlFileName);
            System.out.println("BSOFTLAB. Reading request from file: " +
                    existReturnPrepaymentRequestReaderXml.getFileName());
            existReturnPrepaymentRequest =
                    existReturnPrepaymentRequestReaderXml.readFile();
            existReturnPrepaymentRequest.setSeq(cashRegisterClient.getSeq());
        ...
        try {
            ...
            existReturnPrepaymentResponse = cashRegisterClient
                    .getExistReturnPrepaymentResponse(existReturnPrepaymentRequest);
            ...
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " +
                    existReturnPrepaymentResponse.getResponseCode());
            System.out.println();
        } catch (OperationException operationException) {
            System.out.println(operationException.getMessage());
            return;
        ...
        try {
            ...
            ExistReturnPrepaymentResponseWriterXml existReturnPrepaymentResponseWriterXml
                    = new ExistReturnPrepaymentResponseWriterXml();
            existReturnPrepaymentResponseWriterXml
                    .setFileName(ExistReturnPrepaymentResponseXmlFileName);
            System.out.println("BSOFTLAB. Writing response into file: " +
                    existReturnPrepaymentResponseWriterXml.getFileName());
            existReturnPrepaymentResponseWriterXml.writeFile(existReturnPrepaymentResponse);
