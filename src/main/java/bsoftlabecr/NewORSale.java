...
public class NewORSale {
    public static void main(String[] args) {
        try {
            ...
            newORSaleRequest.setSeq(cashRegisterClient.getSeq());
            ...
            NewORSaleResponse newORSaleResponse = cashRegisterClient.getNewORSaleResponse(newORSaleRequest);
            System.out.println("BSOFTLAB. Request is sent to ECR successfully !");
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " + newORSaleResponse.getResponseCode());
            System.out.println();
