...
import bsoftlabecr.xml.reader.receipt.returns.sale.NewOriginalReturnSaleRequestReaderXml;
import bsoftlabecr.xml.reader.constants.ConstantsReaderXml;
import bsoftlabecr.xml.writer.receipt.returns.sale.NewOriginalReturnSaleResponseWriterXml;
...
public class NewOriginalReturnSale {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            newOriginalReturnSaleRequestReaderXml
                    .setFileName(NewOriginalReturnSaleRequestXmlFileName);
            ...
            newOriginalReturnSaleRequest =
                    newOriginalReturnSaleRequestReaderXml.readFile();
