...
public class ExistRPrepayment {
    public static void main(String[] args) {
        try {
            ...
            ExistRPrepaymentRequestReaderXML existRPrepaymentRequestReaderXML;
            existRPrepaymentRequestReaderXML = new ExistRPrepaymentRequestReaderXML();
            ...
            existRPrepaymentRequest.setSeq(cashRegisterClient.getSeq());
            ...
            existRPrepaymentResponse = cashRegisterClient.getExistRPrepaymentResponse(existRPrepaymentRequest);
            System.out.println("BSOFTLAB. Request is sent to ECR successfully !");
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " + existRPrepaymentResponse.getResponseCode());
            System.out.println();

            System.out.println("BSOFTLAB. Trying to write response into XML file... ");
            ExistRPrepaymentResponseWriterXML existRPrepaymentResponseWriterXML;
            existRPrepaymentResponseWriterXML = new ExistRPrepaymentResponseWriterXML();
