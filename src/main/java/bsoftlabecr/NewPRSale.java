...
public class NewPRSale {
    public static void main(String[] args) {
        try {
            ...
            newPRSaleRequest.setSeq(cashRegisterClient.getSeq());
            ...
            NewPRSaleResponse newPRSaleResponse = cashRegisterClient.getNewPRSaleResponse(newPRSaleRequest);
            System.out.println("BSOFTLAB. Request is sent to ECR successfully !");
            System.out.println("BSOFTLAB. Response is received from ECR successfully: " + newPRSaleResponse.getResponseCode());
            System.out.println();
            ...
            System.out.println("BSOFTLAB. Writing response into file: " + newPRSaleRequestReaderXML.getFileName());
