...
public class ExistRSaleResponseWriterXML {
    ...
    private static final String RESPONSE_OPEN = "<ExistRSaleResponse>";
    private static final String RESPONSE_CLOSE = "</ExistRSaleResponse>";
    ...
    public void writeFile(ExistRSaleResponse existRSaleResponse) throws IOException {
        ...
        writer.write(TAB_KEY + RESPONSE_CID_OPEN + existRSaleResponse.getCid() + RESPONSE_CID_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TIME_OPEN + existRSaleResponse.getTime() + RESPONSE_TIME_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TA_OPEN + existRSaleResponse.getTa() + RESPONSE_TA_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CASH_OPEN + existRSaleResponse.getCash() + RESPONSE_CASH_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CARD_OPEN + existRSaleResponse.getCard() + RESPONSE_CARD_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_PPA_OPEN + existRSaleResponse.getPpa() + RESPONSE_PPA_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_PPU_OPEN + existRSaleResponse.getPpu() + RESPONSE_PPU_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_TYPE_OPEN + existRSaleResponse.getType() + RESPONSE_TYPE_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_REF_OPEN + existRSaleResponse.getRef() + RESPONSE_REF_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_REFCRN_OPEN + existRSaleResponse.getRefcrn() + RESPONSE_REFCRN_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_SALETYPE_OPEN + existRSaleResponse.getSaleType() + RESPONSE_SALETYPE_CLOSE + ENTER_KEY);
        writer.write(TAB_KEY + RESPONSE_CODE_OPEN + existRSaleResponse.getResponseCode() + RESPONSE_CODE_CLOSE + ENTER_KEY);

        if(existRSaleResponse.totals != null && existRSaleResponse.totals.length > 0) {
            writer.write(TAB_KEY + RESPONSE_TOTALS_OPEN + ENTER_KEY);
            for(ExistRSaleResponse.SubTotal subTotal : existRSaleResponse.totals) {
